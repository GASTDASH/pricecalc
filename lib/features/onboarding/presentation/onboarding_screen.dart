    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          body:
              "Приветствуем Вас в приложении Прайс-Калькулятор, созданного для упрощения расчётов цен по заготовленным прайсам",
          image: Image.asset("assets/images/calc.png", height: 200),
        ),
        PageViewModel(
          title: "Удобство использования",
          body:
              "Приложение имеет минималистичный не перегруженный дизайн, в котором сможет разобраться любой пользователь",
